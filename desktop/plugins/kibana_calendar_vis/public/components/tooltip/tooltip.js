...
import { EuiPortal } from './eui_portal';
import { findPopoverPosition } from './popover_positioning';
import { EuiToolTipPopover } from './tool_tip_popover';
import classNames from 'classnames';
import './tooltip_styles/index.less';
...
export class EuiTooltip extends React.Component {
  ...
  componentWillReceiveProps(nextProps) {
    const { anchorEvent, hashTable, formatter } = nextProps;
