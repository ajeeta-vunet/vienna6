...
export const containerName = 'vis-container calendar-vis-container';
export const chartCanvas = 'visualize-chart calendar-chart';
...
export const defaultParams = {
  ...
  addTooltip: true,
  // calendar plugin has its own legend, enabling addLegend renders two legends
  // addLegend: true,
  enableHover: false,
