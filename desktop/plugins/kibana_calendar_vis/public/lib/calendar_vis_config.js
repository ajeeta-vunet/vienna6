...
export class CalendarVisConfig extends BaseConfig {
  ...
  _updateTime() {
    ...
    if (moment(new Date(from)).format('DD MM YYYY') === moment(new Date(to)).format('DD MM YYYY')) {
      // render a day view
      // from date and to date lie on same date. (Eg from: 09/12/2019, to: 09/12/2019)
    ...
    } else if (new Date(from).getMonth() === new Date(to).getMonth() &&
      new Date(from).getFullYear() === new Date(to).getFullYear()) {
      // render a month view
      // from date and to date lie on same month and year. (Eg from: 01/12/2019, to: 25/12/2019)
      ...
      // render a year view
      // anything else we render year view (Eg from: 01/11/2019, to: 15/12/2019)
