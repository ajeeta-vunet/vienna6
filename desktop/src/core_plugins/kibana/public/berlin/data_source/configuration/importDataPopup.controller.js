...
//   constructor($scope,  $uibModalInstance, StateService, Upload, HTTP_SUCCESS_CODE) {
...
//           const headersArray = get_header_row(firstSheetContent);
...
// importPopupCtrl.$inject = ['$scope', '$uibModalInstance', 'StateService', 'Upload', 'HTTP_SUCCESS_CODE'];
// /*eslint-disable*/
