    ...
    params: [
      {
        ...
        filterFieldTypes: function (vis, value) {
          if (vis.type.name === 'tile_map' || vis.type.name === 'region_map' ||
          vis.type.name === 'table' || vis.type.name === 'metric' || vis.type.name === 'matrix') {
            return true;
          }
          return value === 'number';
        },
        ...
        options: [
          ...
          },
          {
            ...
            isCompatibleVis: function (name) {
              return name === 'tile_map' || name === 'region_map' || name === 'metric' || name === 'table' || name === 'matrix';
            },
            disabled: true,
            val: 'concat'
          }
